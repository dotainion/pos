...
import { FormMessgeControl } from "../../components/FormMessgeControl";
...
export const SignIn = () =>{
    ...
    return(
        <form onSubmit={onSubmit}>
            <div className="d-flex align-items-center justify-content-center w-100 vh-100 overflow-auto">
                <div className="small w-sm-100 p-3" style={{minWidth: '400px'}}>
                    ...
                    <FormMessgeControl message={errors} formControl={()=>setErrors(null)} />
